...
* Since $|S| \approx 14000$, the naive method takes up $14000^2 =$ `r 14000^2` steps
* Each step is a disk access, so even if disk I/O is 1ms, that works out to `r 14000^2/1000` seconds
* Which is `r 14000^2/1000/60` minutes
* Which is `r 14000^2/1000/60/60` hours
* Which is `r 14000^2/1000/60/60/24` days
  <br><br>
...
* Since $|S| \approx 14000$ or 140 pages, the **Block Nested Loop** join method takes up $140+140^2 =$ `r 140+140^2` disk I/Os
  <br><br>

* That's a lot better, but it's still quadratic!
* A good index will bring that **up** to `r (140+14000*2.5)` disk I/Os
* But it's **linear**
...
* The grand total is $140 + 14000 \times 1 =$ `r 140 + 14000` disk I/Os
...
* Using these rough estimates, we find
  * Using a tree index: $140 + 14000 \times (1 + 3) =$ `r 140 + 14000*(1+3)` disk I/Os
  * Using a hash index: $140 + 14000 \times (1 + 1.5) =$ `r 140 + 14000*(1+1.5)` disk I/Os
