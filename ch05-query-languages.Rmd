...
* Usually, we only want to keep the dangling tuples from $R$ and not $S$, or vice versa
  <br><br>
* **Left outer join** $R \overset{\circ}{\bowtie_L} S$: Keep dangling tuples from $R$ but not from $S$
* **Right outer join** $R \overset{\circ}{\bowtie_R} S$: Keep dangling tuples from $S$ but not from $R$
