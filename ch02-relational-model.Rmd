...
* (There's a little over 4,000 universities in the US, including community colleges)
  <br><br>
* Joining Facebook's users table with itself would take `r (2.32e9)^2/1000` seconds, or `r (2.32e9)^2/1000/60/60/24` days
* That would be `r (2.32e9)^2/1000/60/60/24/365` years
